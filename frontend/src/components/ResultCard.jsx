...
export default function ResultCard({ data, onOptimize }) {
      ...
      <div className="bg-gray-950 px-8 py-5 border-t border-gray-700">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          {match_score < 100 && onOptimize && (
            <button
              onClick={onOptimize}
              className="bg-gradient-to-r from-blue-600 to-emerald-600 hover:from-blue-500 hover:to-emerald-500 text-white px-6 py-3 rounded-xl font-medium transition-all shadow-lg hover:shadow-xl flex items-center gap-2"
            >
